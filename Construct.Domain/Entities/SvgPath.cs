...
namespace Construct.Domain.Entities
{
    ...
    public class SvgTextBox
    {
        public SvgText? SvgText { get; set; }
        ...
        public string ToSvg(double scale)
        {
            ...
            {
                svgBox = this.SvgText.ToSvgBox(); // todo box uit text halen
                svgText = this.SvgText.ToSvg(scale);

            }
                

            return svgBox + svgText;
