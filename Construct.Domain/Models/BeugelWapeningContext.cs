...
public class BeugelWapeningContext
{
    ...
    /// <summary>
    /// Hart-op-hart afstand tussen beugels in mm
    /// </summary>
    public double Hoh { get; set; } = 100;
    
    /// <summary>
    /// Dwarswapeningshoeveelheid per meter (mm²/m)
    /// Asw = aantal sneden × A per snede × (1000 / hoh)
    /// </summary>
    public double Asw
    {
        get
        {
            double APerSnede = Math.PI * Math.Pow(Diameter / 2, 2);
            return AantalSneden * APerSnede * (1000.0 / Hoh);
        }
    }
    ...
    public override string ToString()
    {
        ...
        return $"r{Diameter}-{Hoh:0} ({sneden})";
    }
}
